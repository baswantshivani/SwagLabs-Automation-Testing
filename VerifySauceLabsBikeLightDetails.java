...
public class VerifySauceLabsBikeLightDetails extends Utility {
	...
	ArrayList<String> expProdDetails=dataread("D:\\Selenium\\Setup\\SwagLabs TestCases\\TestData.xlsx", "Sheet4",1);
	...
	public void login()
	{
		starttestcase("Verifying Bike Lights Product Details");
		...
		for(int i=0; i<Username.size(); i++)
		{
			...
			elementfinder(objhome.SaucelabsBikeLight).click();
	...
	//		actualProdDetails.add(Pname);
		    ...
		    markstatus("info", "Testing Bike Lights Product Details with User" + Username.get(i));
